...
void wheels()
{
		motor[port2] = vexRT[Ch2] + vexRT[Btn6U]*-100 + vexRT[Btn5U]*100;
		motor[port3] = vexRT[Ch2] + vexRT[Btn6U]*100 + vexRT[Btn5U]*-100;
		motor[port4] = vexRT[Ch3] + vexRT[Btn6U]*100 + vexRT[Btn5U]*-100;
		motor[port5] = vexRT[Ch3] + vexRT[Btn6U]*-100 + vexRT[Btn5U]*100;
}
