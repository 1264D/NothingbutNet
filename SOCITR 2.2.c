...
int incrementAmount = 5; //amount to change ideal
int clk; //clock
int lawnchair[2];
int lawnswap;
int ideal;
...
void wheels()
{
	motor[port2] = vexRT[Ch3] + vexRT[Btn6U]*80 + vexRT[Btn5U]*-80;
	motor[port3] = vexRT[Ch3] + vexRT[Btn6U]*-80 +vexRT[Btn5U]*80;
	motor[port4] = vexRT[Ch2] + vexRT[Btn6U]*-80 + vexRT[Btn5U]*80;
	motor[port5] = vexRT[Ch2] + vexRT[Btn6U]*80  + vexRT[Btn5U]*-80;
}
...
task usercontrol()
{
	...
	while(true)
	{
		...
		if(lawnswap == 1)
		{
			line1 = "MANUAL"; //or Battery or batdivk[0];
			lel = 1;
			line2 = enc;
		}
		else
